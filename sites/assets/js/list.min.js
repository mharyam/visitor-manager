(function () {
	...
	frappe.views.ListView = class ListView extends frappe.views.BaseList {
		...
		get_no_result_message() {
			...
			var no_result_message = filters.length
				? __("No {0} found", [__(this.doctype)])
				: __("You haven't created a {0} yet", [__(this.doctype)]);
			var new_button_label = filters.length
		...
		get_column_html(col, doc) {
			...
			var field_html = function () {
				...
				if (
					this$1.settings.formatters &&
					this$1.settings.formatters[fieldname]
				) {
	...
	frappe.views.DashboardView = class DashboardView extends frappe.views.ListView {
		...
		setup_defaults() {
			...
			return super.setup_defaults()
				.then(function () {
					this$1.page_title = __('{0} Dashboard', [this$1.doctype]);
	...
	frappe.templates['kanban_column'] = '<div class="kanban-column" data-column-value="{{title}}">  <div class="kanban-column-header">   <span class="kanban-column-title">    <span class="indicator-pill {{indicator}}"></span>    <span class="kanban-title">{{ __(title) }}</span>   </span>   <div class="column-options dropdown pull-right">    <a data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">     <svg class="icon icon-sm">      <use xlink:href="#icon-dot-horizontal"></use>     </svg>    </a>    <ul class="dropdown-menu" style="max-height: 300px; overflow-y: auto;">     <li><a class="dropdown-item" data-action="archive">{{ __("Archive") }}</a></li>    </ul>   </div>  </div>  <div class="add-card">   <div class="ellipsis">    + {{ __("Add " + doctype) }}   </div>  </div>  <div class="kanban-card new-card-area">   <textarea name="title"></textarea>  </div>  <div class="kanban-cards">  </div> </div>';

	frappe.templates['kanban_card'] = '<div class="kanban-card-wrapper {{ disable_click }}" data-name="{{escape(name)}}">  <a class="kanban-card-redirect" href="#">   <div class="kanban-card content">    <div class="kanban-title-area">     <div class="kanban-card-title" title="{{title}}">      {{ title }}     </div>     <div class="kanban-card-creation">      {{ creation }}     </div>    </div>    <div class="kanban-card-meta">    </div>   </div>  </a> </div>';
